export const no_NO = {
  ...
  NoResults: {
    heading: "Ingen resultater for søket ditt.",
    subheading: "Vær så snill, prøv på nytt..."
  },
  SortDropdown: {
    title: "Sorter etter",
  ...
  ProductContainers: {
    minquery: "Søkeordet ditt {variables.phrase} har ikke nådd minimumsgrensen på {minQueryLength} tegn.",
