...
describe("should sanitize string", () => {
    test("should remove special characters", () => {
        const unsanitizedStr1 = sanitizeString("hello<script>hello</script><div>hello</div>");
...
describe("test validating storeDetails.", () => {
    test("valid storeDetails should remain unchanged", () => {
        ...
        expect(validateStoreDetailsKeys(storeDetails)).toEqual(expectedStoreDetails);
    });
    test("invalid storeDetails should remove unknown keys", () => {
        ...
        expect(validateStoreDetailsKeys(invalidStoreDetails)).toEqual(expectedStoreDetails);
    });
});
