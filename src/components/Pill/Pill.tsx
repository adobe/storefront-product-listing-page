...
export const Pill: FunctionComponent<PillProps> = ({
  ...
  return type === 'transparent' ? (
    <div
      key={label}
      className="text-left ml-2 p-[0.27rem] hover:bg-[#904547] hover:text-white hover:opacity-100 bg-white border border-black rounded-[15px] opacity-50 text-black text-base font-normal font-['Futura Md BT'] whitespace-nowrap"
    >
