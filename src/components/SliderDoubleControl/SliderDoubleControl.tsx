...
export const SliderDoubleControl: FunctionComponent<SliderProps> = ({ filterData }) => {
    ...
    const [minVal, setMinVal] = useState(preSelectedFromPrice ? preSelectedFromPrice : min);
    const [maxVal, setMaxVal] = useState(preSelectedToPrice ? preSelectedToPrice : max);
    ...
    useEffect(() => {
        const controlFromInput = (fromSlider: any, fromInput: any, toInput: any, controlSlider: any) => {
        ...
        const controlToInput = (toSlider: any, fromInput: any, toInput: any, controlSlider: any) => {
            const [from, to] = getParsed(fromInput, toInput);
            fillSlider(fromInput, toInput, "#C6C6C6", "#383838", controlSlider);
            if (from <= to) {
                toSlider.value = to;
        ...
        const controlFromSlider = (fromSlider: any, toSlider: any, fromInput: any) => {
        ...
        const fillSlider = (from: any, to: any, sliderColor: any, rangeColor: any, controlSlider: any) => {
