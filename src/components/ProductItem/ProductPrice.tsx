      ...
      {price && (
        <div className="ds-sdk-product-price">
          {!isBundle &&
            ...
            !isComplexProductView &&
            discount && (
              <p className="ds-sdk-product-price--discount mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
                <span className="line-through pr-2">
                  {getProductPrice(
                    item,
                    currencySymbol,
          ...
          {!isBundle &&
            ...
            !isComplexProductView &&
            !discount && (
              <p className="ds-sdk-product-price--no-discount mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
                {getProductPrice(
                  item,
                  currencySymbol,
                  currencyRate,
          ...
          {isBundle && (
            <div className="ds-sdk-product-price--bundle">
              <p className="mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
          ...
          {isGrouped && (
            <p className="ds-sdk-product-price--grouped mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
              {getPriceFormat(item, currencySymbol, currencyRate, false)}
            </p>
          )}

          {isGiftCard && (
            <p className="ds-sdk-product-price--gift-card mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
          ...
          {!isGrouped &&
            ...
            (isConfigurable || isComplexProductView) && (
              <p className="ds-sdk-product-price--configurable mt-xs text-[0.875rem] font-medium text-gray-900 my-auto">
