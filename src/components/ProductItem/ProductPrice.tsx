...
export const ProductPrice: FunctionComponent<ProductPriceProps> = ({
    ...
    if ("product" in item) {
        ...
        price = item?.refineProduct?.priceRange?.minimum?.final ?? item?.refineProduct?.price?.final;
    }
    ...
    const getPriceFormat = (
        ...
        const priceTranslation = isGiftCard ? translation.ProductCard.from : translation.ProductCard.startingAt;
