...
export const Breadcrumbs: FunctionComponent<BreadcrumbsProps> = ({ pages }: BreadcrumbsProps) => {
    return (
                ...
                {pages.map((page, index) => (
                    <li key={page.name} className="ds-sdk-breadcrumbs__item">
                        <div className="flex items-center">
                            {index > 0 && <Chevron className="h-sm w-sm transform -rotate-90 stroke-gray-400" />}
