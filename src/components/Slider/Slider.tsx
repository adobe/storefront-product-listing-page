...
export const Slider: FunctionComponent<SliderProps> = ({ filterData }) => {
    ...
    const [selectedPrice, setSelectedPrice] = useState(
        !preSelectedToPrice ? filterData.buckets[filterData.buckets.length - 1].to : preSelectedToPrice,
    );
        ...
        <>
            ...
            <div class="ds-sdk-slider slider-container">
                ...
                <div class="price-range-display">
                    <span class="min-price">{formatLabel(filterData.buckets[0].from)}</span>
